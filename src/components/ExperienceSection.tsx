    ...
    const experiences: Experience[] = [
        {
            ...
            description: [
                ...
                "Insurtech WhatsApp AI Assistant (Pellegrinet Seguros): Engineered conversational insurance quote engine over WhatsApp Cloud API seamlessly integrated with the AdminSE management system for automated client triage and policy issuance.",
                "B2B Tradesite & Luxury Brand Experiences (Rutini Wines & Escorihuela Gascón): Architected high-security B2B distributor portal for Rutini Wines and an interactive high-conversion parallax experience for Escorihuela Gascón's Rosaura Malbec.",
                ...
                "Async News AI Pipeline (Hermes · Política del Sur & Appterix): Built an asynchronous backend (Node/Express, Redis, PostgreSQL + pgvector) that scrapes 12+ media sources, deduplicates via semantic vector similarity, and rewrites articles for multichannel publishing.",
                "Multi-Brand Ad Analytics Dashboard & Commercial AI (Flux One): Built analytics engine analyzing $29.4M USD in multi-channel advertising performance with temporal brush filtering and autonomous lead triage.",
                "AI Family Mediation Platform (Mediación): Developed a multiplatform solution (React Native & Web) for conflict resolution using AI (OpenRouter) with strict private position isolation (RN-01), multi-round settlement proposals, and legal digital signatures."
            ],
